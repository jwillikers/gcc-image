...
image:https://quay.io/repository/jwillikers/gcc/status["Docker Repository on Quay", link="https://quay.io/repository/jwillikers/gcc"]
...
[source,sh]
----
➜ podman run --rm -dt --volume "$PWD":/home/user:Z --name gcc quay.io/jwillikers/gcc g++ test/main.cpp
----
