...
[source,sh]
----
➜ podman run --userns keep-id --rm -dt --volume "$PWD":/home/user --name gcc quay.io/jwillikers/gcc:latest g++ test/main.cpp
----
...
[source,sh]
----
➜ podman run --userns keep-id --rm -it --volume "$HOME":/home/user --name gcc quay.io/jwillikers/gcc:latest
----
